        ...
        <tr valign="top">
          <td width="100%"><!--- Left Main Window --->
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0"> 
              ...
              <tr>
                <td rowspan="2" background="<cfoutput>#Request.imagesPrefix#</cfoutput>content_frame_images/content_frame_left.gif"><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" width="6" height="1" alt=""></td>
            ...
            <table width="156" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td bgcolor="#FFFFFF" colspan="3">
					...
					<div align="center"><A href="javascript:void(0);" onClick="showHideRegion('legend');"><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>show-hide-legend.gif" width="84" height="24" border="0" alt="Show/Hide Search Panel"></A><br>&nbsp;</div>
