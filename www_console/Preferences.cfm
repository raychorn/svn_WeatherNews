...
<cfif PageNum EQ 2>
	<cfinclude template="include/PreferencesProc.cfm">		
				...
				<cfquery NAME="getMyFlights" DATASOURCE="#Request.INTRANET_DS#">
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#FFFFFF">
              ...
              <div align="center">
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>AVIATIONEMBLEM.jpg" width="161" height="139"> </p>
              </div>
            </td>
            ...
            <td width="100%" align="left" valign="top" bgcolor="#FFFFFF">
              ...
              <div class="prefBG2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td valign="top">
                      <form name="accountInfoForm" action="<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>" method="post">
					    <cfoutput>
                        <table width="100%" border="0" cellspacing="0" style="padding: 4px 2px 0 0">
                          ...
                          <tr>
                            <td align="right"><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" width="1" height="16"></td>
              ...
              <div class="prefBG2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td valign="top">
                      <form name="passChangeForm" action="<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>" method="post">
					  <cfoutput>
                        <table width="100%" border="0" cellspacing="0" style="padding: 4px 2px 0 0">
                          <tr>
              ...
              <div class="prefBG2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td valign="top">
                      <p><span class="sideMenuFontLev2">Add flights to this list from the <a href="<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?mID=2" class="underline">Instrument Panel</a> page.</span> </p>
                      <div class="prefBG3">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" width="88" height="1" alt=""></td>
                            <td><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" width="88" height="1" alt=""></td>
                            <td><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" height="1" alt=""></td>
                          </tr>
                          <tr valign="bottom">
                      ...
                      <div class="prefBG4">
                        <form name="IPChangeForm" action="<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>" method="post">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 2px 0; border-bottom: 1px solid #72828B">
                            <tr>
								<td><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" width="68" height="1" alt=""></td>
								<td><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" width="68" height="1" alt=""></td>
								<td><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" height="1" alt=""></td>
                            </tr>
              ...
              <div class="prefBG2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td valign="top">
                      <p><span class="sideMenuFontLev2">Add flights to this list from the <a href="<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?mID=3" class="underline">Satellite</a> page.</span> </p>
                      <div class="prefBG3">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" width="88" height="1" alt=""></td>
                      ...
                      <div class="prefBG4">
                        <form name="SatChangeForm" action="<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>" method="post">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 2px 0; border-bottom: 1px solid #72828B">
                            <tr>
								<td><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" width="68" height="1" alt=""></td>
								<td><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" width="68" height="1" alt=""></td>
              ...
              <div class="prefBG2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td valign="top">
                      <p><span class="sideMenuFontLev2">Add flights to this list from the <a href="<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?mID=4" class="underline">Radar</a> page.</span> </p>
                      <div class="prefBG3">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" width="88" height="1" alt=""></td>
