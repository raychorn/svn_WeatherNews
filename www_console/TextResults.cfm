...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<td width="6"><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>content_frame_images/content_corner_top_right.gif" width="6" height="8" alt=""></td>
  </tr>
  <tr>
	<td background="<cfoutput>#Request.imagesPrefix#</cfoutput>content_frame_images/content_frame_left.gif"><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" width="6" height="11" alt=""></td>
	<td width="100%" bgcolor="#FFFFFF" class="serverMessageSub">

	 <cfif gErrString EQ "1">
	  <div align="center">&nbsp;<br>
		<img src="<cfoutput>#Request.imagesPrefix#</cfoutput>main_table_images/alert_icon.gif" width="25" height="24" align="middle"> Sorry! I could not complete your search.<img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" width="25" height="24" align="top"><br>
	 ...
	 <cfelseif gErrString EQ "2">
		  <div align="center">&nbsp;<br><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>main_table_images/alert_icon.gif" width="25" height="24" align="middle"> Sorry, there are no records that match your search criteria.<br>&nbsp; </div>
		<cfset DisplayMore = 0>
	 ...
	 <cfelseif gErrString EQ "9">
		<div align="center">&nbsp;<br>
		<img src="<cfoutput>#Request.imagesPrefix#</cfoutput>main_table_images/alert_icon.gif" width="25" height="24" align="middle"><cfoutput>#gErrStringText#</cfoutput><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" width="25" height="24" align="top"></div>
		<cfset DisplayMore = 0>
	 </cfif>
...
<!--- <cfoutput>#ColOrderBy#<br>RC:#getQuery.RecordCount#<br>S:#StartRow_getQuery#<br>E:#EndRow_getQuery#<br>T:#TotalPages_getQuery#<br></cfoutput> --->
  ...
  <cfoutput>
  <form name="myForm" action="<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>" method="post">
  ...
  <div align=left>&nbsp; <BR>Showing #StartRow_getQuery#-#EndRow_getQuery# of #getQuery.RecordCount# | 
	...
	<cfif (PageNum_getQuery GT 1) AND (ShowAll EQ 0)>
		  <span style="cursor:hand; cursor:pointer" onClick="myForm.action='<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?PageNum_getQuery=#Evaluate(PageNum_getQuery-1)###res';submit();">&lt; Prev</span> |
	<cfelse>
		<span style="color: ##666666">&lt; Prev</span> |  
	</cfif>

	<cfif (PageNum_getQuery LT TotalPages_getQuery) AND (ShowAll EQ 0)>
		  <span style="cursor:hand; cursor:pointer" onClick="myForm.action='<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?PageNum_getQuery=#Evaluate(PageNum_getQuery+1)###res';submit();">Next &gt;</span> |
	<cfelse>
	...
	<cfif ShowAll EQ 1>
		...
		<span style="cursor:hand; cursor:pointer" onClick="myForm.action='<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?ShowAll=0##res';submit();">Show In Pages</span> |
	<cfelse>
		<span style="cursor:hand; cursor:pointer" onClick="myForm.action='<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?ShowAll=1##res';submit();">Show All</span> |
	</cfif>
			  
		  <span style="cursor:hand; cursor:pointer" onClick="myForm.action='<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?Export=1';submit();">Export to Excel</span> | 
		  
		  <span style="cursor:hand; cursor:pointer" onClick="myForm.action='<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?PrintVer=1';submit();">Printable Version</span> | <!--- added ShowAll=1##res --->
	...
	<cfelse>
		...
		<span style="cursor:hand; cursor:pointer" onClick="myForm.action='<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?PrintVer=0';submit();">Return to Search</span>
		</div>
		</CFOUTPUT>
	</cfif>
