  ...
  <div class="SearchMenuBG1" style="padding-right: 6px" align="left">
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
        ...
        <td align="right"><a href="<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?mID=20"><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>preferences_icon.gif" width="9" height="9" border="0" onmouseover="this.T_WIDTH=45;this.T_STATIC=true;this.T_OPACITY=95; return escape('Set Up')"></a></td>
      </tr>
    </table>
  </div>
        ...
        <td>
		  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="savedFlightLinks">
			...
			<cfoutput query="getMyFlights">
				...
				<td width="25%" style="padding: 3px; border-right: 1px solid ##CCC;	border-bottom: 1px solid ##CCC;	border-top: none; border-left: none"><a href="<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?mID=#mID#&fID=#FlightID#" onmouseover="this.T_WIDTH=122;this.T_SHADOWWIDTH=3;this.T_BORDERCOLOR='##B6B8BA';this.T_TEMP=2500;this.T_TITLE='Last Updated';this.T_TITLECOLOR='##003366';return escape('<cf_formatdate inDate=#LastUpdated#>')">#FlightName#</a></td>
			</cfoutput>
            </tr>
          </table>
		  
		<form action="<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>" method="post">
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin: 9px 0 0 0">
		  <tr>
			...
			<td width="62" valign="middle" style="padding: 3px 0px 3px 5px">
			  <input name="SaveFlight" type="image" src="<cfoutput>#Request.imagesPrefix#</cfoutput>forms/save.gif" alt="Save" width="45" height="14" border="0">
			</td>
		  </tr>
		</table>
        </form>
