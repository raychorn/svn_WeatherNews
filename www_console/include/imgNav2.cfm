...
<cfswitch expression="#currMap#">
	<cfcase value="1">
		<table width="95%" border="0" cellpadding="0" cellspacing="0" bgcolor="##FFFFFF">
		  <tr>
			<td width="5" rowspan="2"><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" width="5" height="50" alt=""></td>
			<td width="196" align="left" colspan="2" rowspan="2"><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>login_images/title.gif" alt="Weathernews BEACON" width="485" height="72"></td>
			<td><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" height="30" alt=""></td>
			<td width="5" rowspan="2"><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" width="5" height="50" alt=""></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			<td><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" height="10" alt=""></td>
			<td colspan="2"><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" height="10" alt=""></td>
		  </tr>
		  <tr>
	...
	<cfcase value="3">
		...
		<table width="95%" border="0" cellpadding="0" cellspacing="0" bgcolor="##FFFFFF">
		  ...
		  <tr>
			...
			<cfoutput>
					<a href="javascript:void(0)" onMouseOver="document.bigDisplay.src='#Request.urlPrefix#MCIDAS/charts/UL_WINDS_FL_#FltLevel#_#TimeFile#_#currLoc#.gif'">#TimeDisplay#</a>&nbsp;
			</cfoutput>			
			</cfloop>
			</span>
			</td>
		  ...
		  <tr>
			<td colspan="4" align="center"><cfoutput><img src="#Request.urlPrefix#MCIDAS/charts/UL_WINDS_FL_#FltLevel#_0Z_#currLoc#.GIF" alt="" border="0" name="bigDisplay"></cfoutput></td>
		  </tr>	
		</table>
	</cfcase>
	<cfcase value="4">
	...
	<cfcase value="10">
		...
		<table width="95%" border="0" cellpadding="0" cellspacing="0" bgcolor="##FFFFFF">
		  ...
		  <tr>
			...
			<cfset TimeDisplay = ListGetAt(TimesLoopIndex,2,"|")>
			<cfoutput>
					<a href="javascript:void(0)" onMouseOver="document.bigDisplay.src='#Request.urlPrefix#MCIDAS/charts/UL_WIND_TMP_FL_#FltLevel#_#TimeFile#_#currLoc#.gif'">#TimeDisplay#</a>&nbsp;
			</cfoutput>			
			</cfloop>
			</span>
			</td>
		  ...
		  <tr>
			<td colspan="4" align="center"><cfoutput><img src="#Request.urlPrefix#MCIDAS/charts/UL_WIND_TMP_FL_#FltLevel#_0Z_#currLoc#.GIF" alt="" border="0" name="bigDisplay"></cfoutput></td>
		  </tr>	
		</table>
...
<TR><TD height="40"><p>&nbsp;</p></TD></TR>
<TR>
  <TD bgcolor="#FFFFFF" align="right">&nbsp;<a href="#" onMouseDown="MM_closeBrWindow()"><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>closewindow.gif" width="97" height="20" border="0" alt="close" name="Image1"></a></TD>
</TR>
<TR>
