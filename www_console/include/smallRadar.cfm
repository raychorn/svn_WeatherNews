	...
	<cfif getMyFlightsRADAR.RecordCount EQ 1>
		...
		<cfset mapLayers = LayersOut>
                ...
                <tr>
				  ...
				  <cfoutput>
				  <cfif getMyFlightsRADAR.RecordCount EQ 1>
					  <a href="<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?mID=4&fID=#getMyFlightsRADAR.FlightID#" class="underline">#getMyFlightsRADAR.FlightName#</a>
				  <cfelse>
					  <a href="<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?mID=4" class="underline">Radar</a>
				  </cfif>
				  </cfoutput></span></td>
				  </td>
                  <td align="right" valign="top" style="background-color: #CCE2FF; text-align: right; padding: 3px 5px 3px 0px"><a href="<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?mID=20"><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>preferences_icon.gif" width="9" height="9" border="0" onmouseover="this.T_WIDTH=100;this.T_STATIC=true;this.T_OPACITY=95;return escape('Configure Radar')"></a></td>
                </tr>
