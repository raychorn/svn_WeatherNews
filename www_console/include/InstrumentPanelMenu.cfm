...
<DIV class=sideMenuBG onClick="expandcontent(this, 'sc100')" style="cursor:hand; cursor:pointer"><span class="showstate"></span><SPAN class=sideMenuFontLev1>Observations 2</SPAN></DIV>
	...
	<DIV class=sideMenuBG2><SPAN class=sideMenuFontLev2>
		  <cfif ListFind(CookieList,currID)>
				<img src="<cfoutput>#Request.imagesPrefix#</cfoutput>sidemenu_images/checkBox_on.gif" name="FakeCheckBox_#currID#" id="FakeCheckBox_#currID#" onClick="changeImages('FakeCheckBox_#currID#');newMapLayer('MapSymbols#mID#','#UCASE(cookieMapLayersName)#',#currID#)">
		  <cfelse>
				<img src="<cfoutput>#Request.imagesPrefix#</cfoutput>sidemenu_images/checkBox_off.gif" name="FakeCheckBox_#currID#" id="FakeCheckBox_#currID#" onClick="changeImages('FakeCheckBox_#currID#');newMapLayer('MapSymbols#mID#','#UCASE(cookieMapLayersName)#',#currID#)">
		  </cfif>
		#currName#</SPAN></DIV>
	</cfoutput>
	</cfloop>
