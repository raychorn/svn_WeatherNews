<!--- 	<table width="100%" height="639" align="center"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
	...
	<cfquery NAME="getMyFlightsIP" DATASOURCE="#Request.INTRANET_DS#">
	...
	<cfquery NAME="getMyFlightsSAT" DATASOURCE="#Request.INTRANET_DS#">
		select TOP 1 F.FlightID, F.FlightName, F.BBox, F.MapLayers, F.StageW, F.StageH
		from AvnUsers U, AvnFlights F
		where U.LoginID = '#ListGetAt(cookie.BeaconStats,1,"|")#' 
				AND U.UserID = F.UserID
	...
	<cfquery NAME="getMyFlightsRADAR" DATASOURCE="#Request.INTRANET_DS#">
		select TOP 1 F.FlightID, F.FlightName, F.BBox, F.MapLayers, F.StageW, F.StageH
		from AvnUsers U, AvnFlights F
		where U.LoginID = '#ListGetAt(cookie.BeaconStats,1,"|")#' 
				AND U.UserID = F.UserID
	...
	<cfquery NAME="getMyFlightsCHART" DATASOURCE="#Request.INTRANET_DS#">
		select TOP 1 F.FlightID, F.FlightName, F.BBox, F.MapLayers, F.StageW, F.StageH
		from AvnUsers U, AvnFlights F
		where U.LoginID = '#ListGetAt(cookie.BeaconStats,1,"|")#' 
				AND U.UserID = F.UserID
...
<!--- 	      				<div style="cursor:hand; cursor:pointer;" onClick="redirect('<cfoutput>#Request.default_htm#</cfoutput>?mid=2')">
...
<!---               <div class="menuWrap" id="headlinewrap" style="height: 84px; background: #E3E6E8">
                ...
                <div class="sideMenuBG2" style="padding: 2 0; font-size: 9px"><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>spacer.gif" height="12"></div>
              </div>
 --->
              ...
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
				  ...
				  <cfif getMyFlightsIP.RecordCount EQ 1>
					  <a href="<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?mID=2&fID=#getMyFlightsIP.FlightID#" class="underline">#getMyFlightsIP.FlightName#</a>
				  <cfelse>
					  <a href="<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?mID=2" class="underline">Instrument Panel</a>
				  </cfif>
				  </cfoutput></span></td>
                  <td width="62" align="right" valign="middle" style="background-color: #CCE2FF; border-top: 1px solid #72828B; border-right: 1px solid #B6B8BA; padding: 3px 6px 3px 5px"><a href="<cfoutput>#Request.urlPrefix#</cfoutput><cfoutput>#Request.default_htm#</cfoutput>?mID=20"><img src="<cfoutput>#Request.imagesPrefix#</cfoutput>preferences_icon.gif" width="9" height="9" border="0" onmouseover="this.T_WIDTH=100;this.T_STATIC=true;this.T_OPACITY=95;return escape('Configure the Instrument Panel')"></a> </td>
                </tr>
...
<!---                   <td valign="top" style="height: 416px; border-left: 1px solid #72828B; border-right: 1px solid #B6B8BA; border-bottom: 3px solid #72828B" colspan="2"> --->
                  <td valign="top" colspan="2">
						...
						<OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="https://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab##version=6,0,0,0"
						 ...
						 <EMBED src="/flash/MapSymbols_4.swf"  WIDTH="100%" HEIGHT="400" autostart="false" flashvars="WMS=WorldMap4&localHostName=#localHostName#&FlashID=#flashID#&Layers=#mapLayers#&BBox=#BBox#&WrapDateline=true&Equidistant=true&ToolBarXY=-1,-1&SLO=1" menu=false quality=autohigh scale=noscale salign=LT devicefont=true bgcolor=#mapBgColor# swLiveConnect=true wmode=opaque NAME=MapSymbols#flashID# TYPE="application/x-shockwave-flash" PLUGINSPAGE="https://www.macromedia.com/go/getflashplayer"></EMBED>
						 </OBJECT>
					    </cfoutput>						 
<!---
