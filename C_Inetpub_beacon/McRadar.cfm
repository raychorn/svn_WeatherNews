...
<cffile action="read" file="D:\Data\console\include\conus_mosaic.txt" variable="RadarTimesTmp"> 
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr valign="top">
          <td width="100%"><!--- Left Main Window --->
                  ...
                  <table width="95%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
						<cfif Animate EQ 0>
							<cfoutput> 
							Click <a href="#Request.const_default_htm#?mID=#mID#&Animate=1">here </a> to get the Single Site Radar Animation
			...
			<cfset imageName = "McRadar_" & #RIGHT(ListGetAt(cookie.BeaconStats,1,"|"),10)#>
			<cfhttp url="http://img4.ok.wni.com/mcidas/radar/ss_radar_gen.php?nexradVar=GRR&imgNameVar=#imageName#&bandVar=BREF1" resolveurl="no"></cfhttp>
			
			<cfhttp url="http://img4.ok.wni.com/mcidas/radar/tmpimages/#imageName#6.jpg" path="D:\Data\Console\UserMaps" file="#imageName#_6.gif" resolveurl="yes" getasbinary="yes"></cfhttp>
			<cfhttp url="http://img4.ok.wni.com/mcidas/radar/tmpimages/#imageName#5.jpg" path="D:\Data\Console\UserMaps" file="#imageName#_5.gif" resolveurl="yes" getasbinary="yes"></cfhttp>
			<cfhttp url="http://img4.ok.wni.com/mcidas/radar/tmpimages/#imageName#4.jpg" path="D:\Data\Console\UserMaps" file="#imageName#_4.gif" resolveurl="yes" getasbinary="yes"></cfhttp>
			<cfhttp url="http://img4.ok.wni.com/mcidas/radar/tmpimages/#imageName#3.jpg" path="D:\Data\Console\UserMaps" file="#imageName#_3.gif" resolveurl="yes" getasbinary="yes"></cfhttp>
			<cfhttp url="http://img4.ok.wni.com/mcidas/radar/tmpimages/#imageName#2.jpg" path="D:\Data\Console\UserMaps" file="#imageName#_2.gif" resolveurl="yes" getasbinary="yes"></cfhttp>
			<cfhttp url="http://img4.ok.wni.com/mcidas/radar/tmpimages/#imageName#1.jpg" path="D:\Data\Console\UserMaps" file="#imageName#_1.gif" resolveurl="yes" getasbinary="yes"></cfhttp>
		...
		--->
			...
			<cfset SlideShowList2 = ListQualify(SlideShowList,'"')>
							 ...
							 <a href="/#Request.const_default_htm#?mID=4"><img id="_Ath_Slide" onload="OnImgLoad()" border="0"></a>
...
function do_onload() {
	...
	getobject("_hide").style.display='none';
	Play();
}
...
<!--- 			<cfif Animate EQ 0>
            ...
            <table width=130 border=0 cellpadding=0 cellspacing=0 bgcolor="#FFFFFF">
              <tr>
                <td bgcolor="#E3E6E8">
					<form action="/#Request.const_default_htm#?mID=3" method="post">
					<cfoutput>
<!--- 					<input type="submit" name="Animate" value="Animate" onClick="refreshMovie('MapSymbols#mID#',3)"> --->
					<input type="hidden" name="Animate" value="1">
					<input name="submit" type="image" value="1" src="/images/animation_control_images/buttons_all_off.gif">
					</cfoutput>
					</form>
				</td>
              </tr>
...
<!---                       <td><a href="#" onmouseover="this.T_WIDTH=72;this.T_SHADOWWIDTH=3;this.T_TEMP=2500;return escape('Animation has been stopped. Press PLAY to start it')"><img src="/images/animation_control_images/buttons_1_dim.gif" name="button1" width="22" height="17" border="0" id="button1"></a></td> --->
                      ...
                      <td><a href="/#Request.const_default_htm#?mID=10&Animate=1" onmouseover="this.T_WIDTH=72;this.T_SHADOWWIDTH=3;this.T_TEMP=2500;return escape('Play animation')"><img src="/images/animation_control_images/buttons_3_off.gif" name="button3" width="15" height="17" border="0" id="button3" <!--- onclick="refreshMovie('MapSymbols4',3)"  --->></a></td>
...
<!---                       <td><a href="#" onmouseover="this.T_WIDTH=72;this.T_SHADOWWIDTH=3;this.T_TEMP=2500;return escape('Rewind to first frame')"><span onClick="MM_swapImage('button1','','/images/animation_control_images/buttons_1_on.gif','button2','','/images/animation_control_images/buttons_2_off.gif','button3','','/images/animation_control_images/buttons_3_off.gif','button4','','/images/animation_control_images/buttons_4_off.gif','button5','','/images/animation_control_images/buttons_5_off.gif','button6','','/images/animation_control_images/buttons_6_off.gif','button7','','/images/animation_control_images/buttons_7_off.gif',1);slideshow_first(); return"><img src="/images/animation_control_images/buttons_1_off.gif" name="button1" width="22" height="17" border="0" id="button1"></span></a></td>
                      <td><a href="#" onmouseover="this.T_WIDTH=72;this.T_SHADOWWIDTH=3;this.T_TEMP=2500;return escape('Step back one frame')"><span onClick="MM_swapImage('button1','','/images/animation_control_images/buttons_1_off.gif','button2','','/images/animation_control_images/buttons_2_on.gif','button3','','/images/animation_control_images/buttons_3_off.gif','button4','','/images/animation_control_images/buttons_4_off.gif','button5','','/images/animation_control_images/buttons_5_off.gif','button6','','/images/animation_control_images/buttons_6_off.gif','button7','','/images/animation_control_images/buttons_7_off.gif',1);slideshow_previous(); return"><img src="/images/animation_control_images/buttons_2_off.gif" name="button2" width="15" height="17" border="0" id="button2"></span></a></td>
                      <td><a href="#" onmouseover="this.T_WIDTH=72;this.T_SHADOWWIDTH=3;this.T_TEMP=2500;return escape('Play animation')"><span onClick="MM_swapImage('button1','','/images/animation_control_images/buttons_1_off.gif','button2','','/images/animation_control_images/buttons_2_off.gif','button3','','/images/animation_control_images/buttons_3_on.gif','button4','','/images/animation_control_images/buttons_4_off.gif','button5','','/images/animation_control_images/buttons_5_off.gif','button6','','/images/animation_control_images/buttons_6_off.gif','button7','','/images/animation_control_images/buttons_7_off.gif',1);slideshow_status('Start');return"><img src="/images/animation_control_images/buttons_3_on.gif" name="button3" width="15" height="17" border="0" id="button3"></span></a></td>
                      <td><a href="/#Request.const_default_htm#?mID=4" onmouseover="this.T_WIDTH=72;this.T_SHADOWWIDTH=3;this.T_TEMP=2500;return escape('Return to static map')"><span onClick="MM_swapImage('button1','','/images/animation_control_images/buttons_1_off.gif','button2','','/images/animation_control_images/buttons_2_off.gif','button3','','/images/animation_control_images/buttons_3_off.gif','button4','','/images/animation_control_images/buttons_4_on.gif','button5','','/images/animation_control_images/buttons_5_off.gif','button6','','/images/animation_control_images/buttons_6_off.gif','button7','','/images/animation_control_images/buttons_7_off.gif',1); return"><img src="/images/animation_control_images/buttons_4_off.gif" name="button4" width="15" height="17" border="0" id="button4"></span></a></td>
                      <td><a href="#" onmouseover="this.T_WIDTH=72;this.T_SHADOWWIDTH=3;this.T_TEMP=2500;return escape('Pause animation')"><span onClick="MM_swapImage('button1','','/images/animation_control_images/buttons_1_off.gif','button2','','/images/animation_control_images/buttons_2_off.gif','button3','','/images/animation_control_images/buttons_3_off.gif','button4','','/images/animation_control_images/buttons_4_off.gif','button5','','/images/animation_control_images/buttons_5_on.gif','button6','','/images/animation_control_images/buttons_6_off.gif','button7','','/images/animation_control_images/buttons_7_off.gif',1);slideshow_status('Stop'); return"><img src="/images/animation_control_images/buttons_5_off.gif" name="button5" width="14" height="17" border="0" id="button5"></span></a></td>
                      <td><a href="#" onmouseover="this.T_WIDTH=72;this.T_SHADOWWIDTH=3;this.T_TEMP=2500;return escape('Step forward one frame')"><span onClick="MM_swapImage('button1','','/images/animation_control_images/buttons_1_off.gif','button2','','/images/animation_control_images/buttons_2_off.gif','button3','','/images/animation_control_images/buttons_3_off.gif','button4','','/images/animation_control_images/buttons_4_off.gif','button5','','/images/animation_control_images/buttons_5_off.gif','button6','','/images/animation_control_images/buttons_6_on.gif','button7','','/images/animation_control_images/buttons_7_off.gif',1);slideshow_next(); return"><img src="/images/animation_control_images/buttons_6_off.gif" name="button6" width="15" height="17" border="0" id="button6"></span></a></td>
...
<!---			 
            ...
            <table width=130 border=0 cellpadding=0 cellspacing=0 bgcolor="#FFFFFF">
              <tr>
                <td bgcolor="#E3E6E8"><img src="/images/animation_control_images/spacer.gif" width=6 height=1 alt=""></td>
                <td><img src="/images/animation_control_images/ani_top_left.gif" width=5 height=5 alt=""></td>
                <td colspan=3><img src="/images/animation_control_images/ani_top_edge.gif" width=120 height=5 alt=""></td>
                <td><img src="/images/animation_control_images/ani_top_right.gif" width=5 height=5 alt=""></td>
              </tr>
              <tr>
                <td bgcolor="#E3E6E8"><img src="/images/animation_control_images/spacer.gif" width=6 height=1 alt=""></td>
                <td><img src="/images/animation_control_images/spacer.gif" width=5 height=8 alt=""></td>
                <td colspan=3><img src="/images/animation_control_images/default_cap.gif" alt="" name="caption" width=120 height=8 id="caption"></td>
                <td><img src="/images/animation_control_images/ani_right_edge.gif" width=5 height=8 alt=""></td>
              </tr>
              <tr>
                <td bgcolor="#E3E6E8"><img src="/images/animation_control_images/spacer.gif" width=6 height=1 alt=""></td>
                <td><img src="/images/animation_control_images/spacer.gif" width=5 height=17 alt=""></td>
                <td colspan=3><img src="/images/animation_control_images/buttons_all_off.gif" alt="" name="buttonBar" width=120 height=17 border="0" usemap="#buttonBarMap" id="buttonBar"></td>
                <td background="/images/animation_control_images/ani_right_edge.gif"><img src="/images/animation_control_images/spacer.gif" width=5 height=17 alt=""></td>
              </tr>
              <tr>
                <td bgcolor="#E3E6E8"><img src="/images/animation_control_images/spacer.gif" width=6 height=1 alt=""></td>
                <td><img src="/images/animation_control_images/spacer.gif" width=5 height=12 alt=""></td>
                <td><img src="/images/animation_control_images/speed_slider_3.gif" alt="" name="slider" width=55 height=12 border="0" usemap="#sliderMap" id="slider"></td>
                <td><img src="/images/animation_control_images/spacer.gif" width=9 height=12 alt=""></td>
                <td><img src="/images/animation_control_images/frame_no_1.gif" alt="" name="currFrame" width=56 height=12 border="0" usemap="#currFrameMap" id="currFrame"></td>
                <td background="/images/animation_control_images/ani_right_edge.gif"><img src="/images/animation_control_images/spacer.gif" width=5 height=12 alt=""></td>
              </tr>
              <tr>
                <td bgcolor="#E3E6E8"><img src="/images/animation_control_images/spacer.gif" width=6 height=1 alt=""></td>
                <td><img src="/images/animation_control_images/ani_bottom_left.gif" width=5 height=4 alt=""></td>
                <td colspan=3><img src="/images/animation_control_images/spacer.gif" width=120 height=4 alt=""></td>
                <td><img src="/images/animation_control_images/ani_bottom_right.gif" width=5 height=4 alt=""></td>
              </tr>
            </table>
            <!-- End animation control -->
...
<area shape="rect" coords="0,0,21,17" href="javascript: slideshow_first();" alt="rewind" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/rewind_cap.gif','buttonBar','','/images/animation_control_images/buttons_1_on.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
<area shape="rect" coords="21,0,35,17" href="javascript: slideshow_previous();" alt="step back" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/step_back_cap.gif','buttonBar','','/images/animation_control_images/buttons_2_on.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
<area shape="rect" coords="35,0,47,17" href="#" alt="reverse" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/reverse_cap.gif','buttonBar','','/images/animation_control_images/buttons_3_on.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">

<cfif Animate EQ 0>
	<area shape="rect" coords="47,0,60,17" href="/#Request.const_default_htm#?mID=3&Animate=1" alt="Play" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/start_ani_cap.gif','buttonBar','','/images/animation_control_images/buttons_4_on.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
<cfelse>
	<area shape="rect" coords="47,0,60,17" href="javascript: slideshow_status('Start');" alt="Play" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/start_ani_cap.gif','buttonBar','','/images/animation_control_images/buttons_4_on.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
</cfif>

<area shape="rect" coords="60,0,74,17" href="/#Request.const_default_htm#?mID=3" alt="stop animation" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/stop_ani_cap.gif','buttonBar','','/images/animation_control_images/buttons_5_on.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
<area shape="rect" coords="74,0,85,17" href="javascript: slideshow_status('Stop');" alt="pause animation" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/pause_cap.gif','buttonBar','','/images/animation_control_images/buttons_6_on.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
<area shape="rect" coords="85,0,99,17" href="javascript: slideshow_next();" alt="step forward" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/step_forward_cap.gif','buttonBar','','/images/animation_control_images/buttons_7_on.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
<area shape="rect" coords="99,0,120,17" href="javascript: slideshow_last();" alt="advance to end" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/advance_ff_cap.gif','buttonBar','','/images/animation_control_images/buttons_8_on.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
</map>
 ---><!-- start image map for animation speed control (add your triggers for animation here?) -->
<!--- <map name="sliderMap">
<area shape="rect" coords="0,0,11,12" href="#" onClick="setDelay(5000);MM_swapImage('slider','','/images/animation_control_images/speed_slider_1.gif',1)" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/speed_cap.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
<area shape="rect" coords="11,0,22,12" href="#" onClick="setDelay(3000);MM_swapImage('slider','','/images/animation_control_images/speed_slider_2.gif',1)" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/speed_cap.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
<area shape="rect" coords="22,0,33,12" href="#"  onClick="setDelay(2000);MM_swapImage('slider','','/images/animation_control_images/speed_slider_3.gif',1)" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/speed_cap.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
<area shape="rect" coords="33,0,44,12" href="#"  onClick="setDelay(1000);MM_swapImage('slider','','/images/animation_control_images/speed_slider_4.gif',1)" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/speed_cap.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
<area shape="rect" coords="44,0,55,12" href="#"  onClick="setDelay(200);MM_swapImage('slider','','/images/animation_control_images/speed_slider_5.gif',1)" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/speed_cap.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
</map>
 --->
<map name="sliderMap">
...
<area shape="rect" coords="2,0,10,12" href="#" alt="frame 1" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/frame_cap.gif','currFrame','','/images/animation_control_images/frame_no_1.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
<area shape="rect" coords="10,0,19,12" href="#" alt="frame 2" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/frame_cap.gif','currFrame','','/images/animation_control_images/frame_no_2.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
<area shape="rect" coords="19,0,28,12" href="#" alt="frame 3" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/frame_cap.gif','currFrame','','/images/animation_control_images/frame_no_3.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
<area shape="rect" coords="28,0,37,12" href="#" alt="frame 4" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/frame_cap.gif','currFrame','','/images/animation_control_images/frame_no_4.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
<area shape="rect" coords="37,0,46,12" href="#" alt="frame 5" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/frame_cap.gif','currFrame','','/images/animation_control_images/frame_no_5.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
<area shape="rect" coords="46,0,55,12" href="#" alt="frame 6" onMouseOver="MM_swapImage('caption','','/images/animation_control_images/frame_cap.gif','currFrame','','/images/animation_control_images/frame_no_6.gif',1)" onMouseOut="MM_swapImage('caption','','/images/animation_control_images/default_cap.gif',1)">
</map>
 --->  
