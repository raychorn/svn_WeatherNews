...
<!--- 	      				<div style="cursor:hand; cursor:pointer;" onClick="redirect('#Request.const_default_htm#?mid=2')">
              ...
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
				  ...
				  <cfif getMyFlightsIP.RecordCount EQ 1>
					  <a href="/#Request.const_default_htm#?mID=2&fID=#getMyFlightsIP.FlightID#" class="underline">#getMyFlightsIP.FlightName#</a>
				  <cfelse>
					  <a href="/#Request.const_default_htm#?mID=2" class="underline">Instrument Panel</a>
				  </cfif>
				  </cfoutput></span></td>
                  <td width="62" align="right" valign="middle" style="background-color: #CCE2FF; border-top: 1px solid #72828B; border-right: 1px solid #B6B8BA; padding: 3px 6px 3px 5px"><a href="/#Request.const_default_htm#?mID=20"><img src="/images/preferences_icon.gif" width="9" height="9" border="0" onmouseover="this.T_WIDTH=100;this.T_STATIC=true;this.T_OPACITY=95;return escape('Configure the Instrument Panel')"></a> </td>
                </tr>
