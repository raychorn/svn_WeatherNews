	...
	<cfif getMyFlightsCHART.RecordCount EQ 1>
		...
		<cfset mapLayers = LayersOut>
                ...
                <tr>
				  ...
				  <cfoutput>
				  <cfif getMyFlightsCHART.RecordCount EQ 1>
					  <a href="/#Request.const_default_htm#?mID=5&fID=#getMyFlightsCHART.FlightID#" class="underline">#getMyFlightsCHART.FlightName#</a>
				  <cfelse>
					  <a href="/#Request.const_default_htm#?mID=5" class="underline">Chart</a>
				  </cfif>
				  </cfoutput></span></td>
				  </td>
<!---                   <td align="right" valign="top" style="background-color: #CCE2FF; text-align: right; padding: 3px 5px 3px 0px"><a href="/#Request.const_default_htm#?mID=20"><img src="/images/preferences_icon.gif" width="9" height="9" border="0" onmouseover="this.T_WIDTH=100;this.T_STATIC=true;this.T_OPACITY=95;return escape('Configure Charts')"></a></td> --->
                </tr>
				
                <tr>
                  <td colspan="2">
				 		<img src="/MCIDAS/charts/UL_WINDS_FL_340_12Z_ATL_THUMB.jpg"  width="100%" height="113" alt="" id="ul_winds_thumb" />
