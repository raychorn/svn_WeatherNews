		...
		<cfset mapLayers = LayersOut>
              ...
              <table width="159" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 6px; border: 1px solid #72828B">
                <tr>
				  ...
				  <cfoutput>
				  <cfif getMyFlightsSAT.RecordCount EQ 1>
					  <a href="/#Request.const_default_htm#?mID=3&fID=#getMyFlightsSAT.FlightID#" class="underline">#getMyFlightsSAT.FlightName#</a>
				  <cfelse>
					  <a href="/#Request.const_default_htm#?mID=3" class="underline">Satellite</a>
				  </cfif>
				  </cfoutput></span></td>
				  </td>
                  <td align="right" valign="top" style="background-color: #CCE2FF; text-align: right; padding: 3px 5px 3px 0px"><a href="/#Request.const_default_htm#?mID=20"><img src="/images/preferences_icon.gif" width="9" height="9" border="0" onmouseover="this.T_WIDTH=100;this.T_STATIC=true;this.T_OPACITY=95;return escape('Configure Satellite')"></a></td>
                </tr>
