...
<cfelse>
	...
	<cfhttp url="http://localhost:83/WMS/wms.asp?WMS=WorldMap4&request=map&srs=EPSG:4326&BBOX=#BBox#&width=#stageW#&height=#stageH#&layers=#AnimMapLayers6#&transparent=true&format=GIF" path="D:\Data\Console\UserMaps" file="#imageName#_6.gif" resolveurl="yes" getasbinary="yes"></cfhttp>
	<cfhttp url="http://localhost:83/WMS/wms.asp?WMS=WorldMap4&request=map&srs=EPSG:4326&BBOX=#BBox#&width=#stageW#&height=#stageH#&layers=#AnimMapLayers5#&transparent=true&format=GIF" path="D:\Data\Console\UserMaps" file="#imageName#_5.gif" resolveurl="yes" getasbinary="yes"></cfhttp>
	<cfhttp url="http://localhost:83/WMS/wms.asp?WMS=WorldMap4&request=map&srs=EPSG:4326&BBOX=#BBox#&width=#stageW#&height=#stageH#&layers=#AnimMapLayers4#&transparent=true&format=GIF" path="D:\Data\Console\UserMaps" file="#imageName#_4.gif" resolveurl="yes" getasbinary="yes"></cfhttp>
	<cfhttp url="http://localhost:83/WMS/wms.asp?WMS=WorldMap4&request=map&srs=EPSG:4326&BBOX=#BBox#&width=#stageW#&height=#stageH#&layers=#AnimMapLayers3#&transparent=true&format=GIF" path="D:\Data\Console\UserMaps" file="#imageName#_3.gif" resolveurl="yes" getasbinary="yes"></cfhttp>
	<cfhttp url="http://localhost:83/WMS/wms.asp?WMS=WorldMap4&request=map&srs=EPSG:4326&BBOX=#BBox#&width=#stageW#&height=#stageH#&layers=#AnimMapLayers2#&transparent=true&format=GIF" path="D:\Data\Console\UserMaps" file="#imageName#_2.gif" resolveurl="yes" getasbinary="yes"></cfhttp>
	<cfhttp url="http://localhost:83/WMS/wms.asp?WMS=WorldMap4&request=map&srs=EPSG:4326&BBOX=#BBox#&width=#stageW#&height=#stageH#&layers=#AnimMapLayers1#&transparent=true&format=GIF" path="D:\Data\Console\UserMaps" file="#imageName#_1.gif" resolveurl="yes" getasbinary="yes"></cfhttp>
