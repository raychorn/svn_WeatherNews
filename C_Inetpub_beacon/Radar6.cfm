                  ...
                  <table width="95%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
						...
						<cfelse>
<!--- 				 		  <cfoutput>
							<cf_img javacode rotatedelay="1000" slideshow="#SlideShowList#" NOSRC="/images/noImage.jpg">
							<cf_img name="show" href="/#Request.const_default_htm#?mID=4" src="#ListFirst(SlideShowList,',')#" NOSRC="/images/noImage.jpg" TITLE="Click on the image to Redefine Your Selection" ALT="Click on the image to Redefine Your Selection">
						 </cfoutput>		
...
<!---                       <td><a href="#" onmouseover="this.T_WIDTH=72;this.T_SHADOWWIDTH=3;this.T_TEMP=2500;return escape('Animation has been stopped. Press PLAY to start it')"><img src="/images/animation_control_images/buttons_1_dim.gif" name="button1" width="22" height="17" border="0" id="button1"></a></td> --->
                      ...
                      <td><a href="/#Request.const_default_htm#?mID=4&Animate=1" onmouseover="this.T_WIDTH=72;this.T_SHADOWWIDTH=3;this.T_TEMP=2500;return escape('Play animation')"><img src="/images/animation_control_images/buttons_3_off.gif" name="button3" width="15" height="17" border="0" id="button3" <!--- onclick="refreshMovie('MapSymbols4',3)"  --->></a></td>
