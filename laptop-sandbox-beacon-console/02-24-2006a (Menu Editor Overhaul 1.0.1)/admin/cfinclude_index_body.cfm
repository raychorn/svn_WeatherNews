...
// +++  (Trace through the server actions to see how this function is supposed to work and then make it work...)
											//	_alert('srcTableName = [' + aDict.getValueFor('srcTableName') + ']' + ', srcId = [' + srcId + ']' + ', menuUUID = [' + menuUUID + ']' + ', parentId = [' + aDict.getValueFor('parentId') + ']' + ', dispOrder = [' + dispOrder + ']' + '\n\nkids.length = [' + kids.length + ']' + '\n\nkids = [' + kids + ']' + '\n\nglobal_dict = [' + global_dict + ']' + '\n\naDict = [' + aDict + ']');
												if (kids.length > 0) {
