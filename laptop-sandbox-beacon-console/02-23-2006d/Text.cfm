...
<!--- save for later
 ...
 --->
						...
						<div class="SearchMenuBG2"><span class="sideMenuFontLev2"><input type="radio" name="repType" id="repType" id="repType" value="7" <cfif repType EQ "7">checked</cfif> onClick="expandcontent(this, 'sc7');switchRegion('region7');enableTime(7);" style="cursor:hand; cursor:pointer;">Volcanic Ash Advisories</span></div>
                      ...
                      <div class="menuWrap"  style="height: 50px">
						...
						<div id="timeCtrl">
                          <span class="selectLabel">From:</span>
							<select name="PeriodFrom" size="1"  style="font-size: 10px" onChange="enableTime(1);">
	                          ...
	                          <span class="selectLabel">To:</span>
								<select name="PeriodTo" size="1" style="font-size: 10px" onChange="enableTime(1);">
