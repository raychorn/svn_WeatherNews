<cfapplication name="BEACON" clientmanagement="Yes" sessionmanagement="Yes" sessiontimeout="#CreateTimeSpan(0,1,0,0)#" applicationtimeout="#CreateTimeSpan(1,0,0,0)#" clientstorage="cf_client" loginstorage="Session">
...
<cfset demisLocation = "http://demis-qa.wni.com/wms/wms.asp" />