		...
		<!--
			...
			function handleMenuSelection(sObj, _spanName) {
				...
				if ( (!!dObj) && (!!tObj) ) {
					...
					//	_alert('sObj.selectedIndex = [' + sObj.selectedIndex + ']' + ', brObj.selectedIndex = [' + brObj.selectedIndex + ']' + ', global_menuEditorObj.isItemEditorOpen = [' + global_menuEditorObj.isItemEditorOpen + ']' + ', tObj.value = [' + tObj.value + ']' + ', aDict = [' + aDict + ']');

							global_dict.push(tObj.value, [aDict.getValueFor('ID'),_spanName,_menuUUID]);
...
// +++  (Trace through the server actions to see how this function is supposed to work and then make it work...)
											//	_alert('srcTableName = [' + aDict.getValueFor('srcTableName') + ']' + ', srcId = [' + srcId + ']' + ', menuUUID = [' + aDict.getValueFor('menuUUID') + ']' + ', parentId = [' + aDict.getValueFor('parentId') + ']' + ', (dispOrder + 1) = [' + (dispOrder + 1) + ']' + '\nglobal_dict = [' + global_dict + ']' + '\naDict = [' + aDict + ']');
