        ...
        <td>
		  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="savedFlightLinks">
			...
			<cfoutput query="getMyFlights">
				...
				<td width="25%" style="padding: 3px; border-right: 1px solid ##CCC;	border-bottom: 1px solid ##CCC;	border-top: none; border-left: none"><a href="/default.htm?mID=#mID#&fID=#FlightID#" onmouseover="this.T_WIDTH=122;this.T_SHADOWWIDTH=3;this.T_BORDERCOLOR='##B6B8BA';this.T_TEMP=2500;this.T_TITLE='Last Updated';this.T_TITLECOLOR='##003366';return escape('<cf_formatdate inDate=#LastUpdated#>')">#FlightName#</a></td>
			</cfoutput>
            </tr>
          </table>
