...
var contractsymbol='<img src="/images/Next.gif">'
var expandsymbol='<img src="/images/Down.gif">'
...
//	alert("inside change Image2: " + document.images[imgId].src + "index is: " + document.images[imgId].src.indexOf("down.gif") );
		if (document.images[imgId].src.indexOf("obs_on.jpg") > 0 )
			document.images[imgId].src = "../images/obs_off.jpg";
		else	
			document.images[imgId].src = "../images/obs_on.jpg";
}
...
<DIV class=sideMenuBG><SPAN class=sideMenuFontLev1>Satellite</SPAN></DIV>
	...
	<cffile action="read" file="D:\Data\console\flash\xml\layers.xml" variable="XMLFileText">
	...
	<DIV class=sideMenuBG2><SPAN class=sideMenuFontLev2>
		  <cfif ListFind(CookieList,currID)>
				<img src="../images/obs_on.jpg" name="FakeCheckBox_#currID#" id="FakeCheckBox_#currID#" onClick="changeImages('FakeCheckBox_#currID#');parent.newMapLayer('MapSymbols#mID#','#UCASE(cookieMapLayersName)#',#currID#)">
		  <cfelse>
				<img src="../images/obs_off.jpg" name="FakeCheckBox_#currID#" id="FakeCheckBox_#currID#" onClick="changeImages('FakeCheckBox_#currID#');parent.newMapLayer('MapSymbols#mID#','#UCASE(cookieMapLayersName)#',#currID#)">
		  </cfif>
		#currName#</SPAN></DIV>
	</cfoutput>
	</cfloop>
