            ...
            <td width="100%" align="left" valign="top" bgcolor="#FFFFFF">
              ...
              <div class="prefBG2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td valign="top">
                      <form name="accountInfoForm" action="/default.htm" method="post">
					    <cfoutput>
              ...
              <div class="prefBG2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td valign="top">
                      <form name="passChangeForm" action="/default.htm" method="post">
					  <cfoutput>
                        <table width="100%" border="0" cellspacing="0" style="padding: 4px 2px 0 0">
                          <tr>
              ...
              <div class="prefBG2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td valign="top">
                      <p><span class="sideMenuFontLev2">Add flights to this list from the <a href="/default.htm?mID=2" class="underline">Instrument Panel</a> page.</span> </p>
                      <div class="prefBG3">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                      ...
                      <div class="prefBG4">
                        <form name="IPChangeForm" action="/default.htm" method="post">
              ...
              <div class="prefBG2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td valign="top">
                      <p><span class="sideMenuFontLev2">Add flights to this list from the <a href="/default.htm?mID=3" class="underline">Satellite</a> page.</span> </p>
                      <div class="prefBG3">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><img src="/images/spacer.gif" width="88" height="1" alt=""></td>
                      ...
                      <div class="prefBG4">
                        <form name="SatChangeForm" action="/default.htm" method="post">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 2px 0; border-bottom: 1px solid #72828B">
                            <tr>
								<td><img src="/images/spacer.gif" width="68" height="1" alt=""></td>
								<td><img src="/images/spacer.gif" width="68" height="1" alt=""></td>
              ...
              <div class="prefBG2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td valign="top">
                      <p><span class="sideMenuFontLev2">Add flights to this list from the <a href="/default.htm?mID=4" class="underline">Radar</a> page.</span> </p>
                      <div class="prefBG3">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><img src="/images/spacer.gif" width="88" height="1" alt=""></td>
