					...
					<cfoutput>
						...
						<cfif ColOrderBy EQ ListFind(ColNameList,ColName,";")> <!--- Sort on column --->
							<cfif ColOrderDir EQ 'ASC'>
								...
								<a href="#CurrentPage#?#goWhere#">#ColName#</a> <img src="/images/up.gif" border="0" align="absmiddle">
							<cfelse>
								<cfset goWhere = Replace(QueryString_getQuery,'ColOrderDir=DESC','ColOrderDir=ASC')>
								<a href="#CurrentPage#?#goWhere#">#ColName#</a> <img src="/images/down.gif" border="0" align="absmiddle">
							</cfif>
						<cfelse>
				...
				<tr>
				  <td width="13%" align="center">
					<cfif PageNum_getQuery GT 1>
					  <a href="#CurrentPage#?PageNum_getQuery=1#QueryString_getQuery#"><img src="/images/First.gif" border=0></a>
					</cfif>
				  </td>
				  <td width="13%" align="center">
					<cfif PageNum_getQuery GT 1>
					  <a href="#CurrentPage#?PageNum_getQuery=#Max(DecrementValue(PageNum_getQuery),1)##QueryString_getQuery#"><img src="/images/Previous.gif" border=0></a>
					</cfif>
				  </td>
				  ...
				  <td width="13%" align="center">
					<cfif PageNum_getQuery LT TotalPages_getQuery>
					  <a href="#CurrentPage#?PageNum_getQuery=#Min(IncrementValue(PageNum_getQuery),TotalPages_getQuery)##QueryString_getQuery#"><img src="/images/Next.gif" border=0></a>
					</cfif>
				  </td>
				  <td width="13%" align="center">
					<cfif PageNum_getQuery LT TotalPages_getQuery>
					  <a href="#CurrentPage#?PageNum_getQuery=#TotalPages_getQuery##QueryString_getQuery#"><img src="/images/Last.gif" border=0></a>
					</cfif>
				  </td>
				</tr>
			  </table>
