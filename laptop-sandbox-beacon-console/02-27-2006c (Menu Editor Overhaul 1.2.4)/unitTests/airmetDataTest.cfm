<cfif IsDefined("FORM.from")>
	...
	<cfswitch expression="#FORM.region#">
		<cfcase value="usa">
			<!--- USA --->
			<cfinvoke component="com.weathernews.beacon.DAO.qryGetAIRMETS" method="init" returnvariable="query">
...
<title>Airmet Data QC Check</title>
<style>
	body {
...
<body>
	<h3>Please make selections below to view AIRMET Data.  This is for Data QC only</h3>
	<div id="form">
	<form name="sigmetQC" action="airmetDataTest.cfm" method="post">
