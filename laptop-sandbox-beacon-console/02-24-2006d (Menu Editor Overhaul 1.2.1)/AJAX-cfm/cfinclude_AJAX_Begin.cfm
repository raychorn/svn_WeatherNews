...
<cfset bool_canDebugHappen = true>
...
<cfelse>
	...
	<cfoutput>
		<cfif (bool_canDebugHappen)>
			...
			BEGIN: #Request.commonCode.blue_formattedModuleName('cfinclude_AJAX_Begin.cfm')#<br>
		...
		<cfif (bool_canDebugHappen)>
			...
			END! #Request.commonCode.blue_formattedModuleName('cfinclude_AJAX_Begin.cfm')#<br>
		</cfif>
	</cfoutput>
