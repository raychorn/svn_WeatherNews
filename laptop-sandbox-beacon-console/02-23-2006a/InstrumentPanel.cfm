              ...
              <tr>
                ...
                <td bgcolor="#FFFFFF" colspan="3">
					...
					<div id="fpl">
						...
						<cfoutput>
							<input id="execute" name="submit" value="Display" type="button" onClick="reloadMap('#flashID#');"/><br /><br />
							<input id="clear" name="clear" value="Clear" type="button" onClick="clearMenu('#flashID#');" />
						</cfoutput>
					</div><br />
					<!--- Don't need legends with dynamic legends --->
