...
class AnimationClass extends MovieClip {
	...
	public function AnimationClass(tmpClipID) {
		//_level0.debugBox.text = _level0.debugBox.text+"animationclass initialization<BR>";
		clipID = tmpClipID;
		initialize();
	}
	...
	public function loadFrames(tmpLayerArray, tmpTimeArray):Number {
		...
		//_level0.debugBox.text = _level0.debugBox.text+"loadFrames<BR>";
		...
		//_level0.debugBox.text = _level0.debugBox.text+"x:"+x+"<BR>";
			...
			_level0.timeBox.font = "Verdana";
			_level0.timeBox.size = 10;
			//_level0.timeBox.setTextFormat(newTimeBoxTextFormat);
	...
	public function playAnimation():Void {		
			var newTimeBoxTextFormat = new TextFormat();
			newTimeBoxTextFormat.color = 0xffffff;
			newTimeBoxTextFormat.font = "Verdana";
			newTimeBoxTextFormat.size = 10;
			newTimeBoxTextFormat.bold = true;
		try {	
