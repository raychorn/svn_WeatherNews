...
var contractsymbol='<img src="/images/MenuArrowOn.gif">'
var expandsymbol='<img src="/images/MenuArrowOff.gif">'
...
function enableTime(value) {
	if(value == 8 || value == 7) {
		document.getElementById('timeCtrl').style.display = 'none';
		document.getElementById('textSubmit').disabled = false;
	} else {
			if(document.getElementById('repType').value) {
				document.getElementById('timeCtrl').style.display = 'block';
				document.getElementById('textSubmit').disabled = false;
			}
	}
}
...
<cfset ProductList2 = ProductList2 & "25;Sandstorm" & "|">
...
<cfset ProductList4 = ProductList4 & "41;Icing" & "|">
<cfset ProductList4 = ProductList4 & "42;Turbulence" & "|">
<!--- <cfset ProductList4 = ProductList4 & "43;Convective" & "|">
<cfset ProductList4 = ProductList4 & "44;Volcanic Ash" & "|"> --->
...
<cfset subProductList2 = subProductList2 & "s218;Eastern U.S." & "|">
<cfset subProductList2 = subProductList2 & "s219;Central U.S." & "|">
<cfset subProductList2 = subProductList2 & "s220;Western U.S." & "|">
<cfset subProductList2 = subProductList2 & "s221;Eastern Canada" & "|">
<cfset subProductList2 = subProductList2 & "s222;Western Canada" & "|">
<cfset subProductList2 = subProductList2 & "s223;Alaska" & "|">
<cfset subProductList2 = subProductList2 & "s224;Caribbean" & "|">
<cfset subProductList2 = subProductList2 & "s225;Central America" & "|">
<cfset subProductList2 = subProductList2 & "s226;South America" & "|">
<cfset subProductList2 = subProductList2 & "s227;Western Europe" & "|">
<cfset subProductList2 = subProductList2 & "s228;Eastern Europe" & "|">
<cfset subProductList2 = subProductList2 & "s229;Middle East" & "|">
<cfset subProductList2 = subProductList2 & "s230;Central Asia" & "|">
<cfset subProductList2 = subProductList2 & "s231;Russia / Kazakhstan" & "|">
<cfset subProductList2 = subProductList2 & "s232;Eastern Asia" & "|">
<cfset subProductList2 = subProductList2 & "s233;Southeast Asia" & "|">
<cfset subProductList2 = subProductList2 & "s234;Australia / New Zealand" & "|">
<cfset subProductList2 = subProductList2 & "s235;Africa" & "|">
<cfset subProductList2 = subProductList2 & "s236;North Atlantic" & "|">
<cfset subProductList2 = subProductList2 & "s237;Western Atlantic" & "|">
<cfset subProductList2 = subProductList2 & "s238;Central Atlantic" & "|">
<cfset subProductList2 = subProductList2 & "s239;South Atlantic" & "|">
<cfset subProductList2 = subProductList2 & "s240;North Pacific" & "|">
<cfset subProductList2 = subProductList2 & "s241;Central Pacific" & "|">
<cfset subProductList2 = subProductList2 & "s242;South Pacific" & "|">
<cfset subProductList2 = subProductList2 & "s243;Indian Ocean" & "|">
...
<cfset subProductList4 = subProductList4 & "s41;United States of America" & "|">
<!--- <cfset subProductList2 = subProductList2 & "s22;U.S. Non-Convective" & "|">--->
<cfset subProductList4 = subProductList4 & "s42;North Eastern U.S." & "|">
<cfset subProductList4 = subProductList4 & "s43;South Eastern U.S." & "|">
<cfset subProductList4 = subProductList4 & "s44;North Central U.S." & "|">
<cfset subProductList4 = subProductList4 & "s45;South Central U.S." & "|">
<cfset subProductList4 = subProductList4 & "s46;North Western U.S." & "|">
<cfset subProductList4 = subProductList4 & "s47;Southwestern U.S." & "|">
<!--- <cfset subProductList4 = subProductList4 & "s48;Western Canada" & "|">
<cfset subProductList4 = subProductList4 & "s49;Eastern Canada" & "|"> --->
<cfset subProductList4 = subProductList4 & "s490;Alaska" & "|">
<cfset subProductList4 = subProductList4 & "s491;Hawaii" & "|">
...
<cfset SubProductList31 ="">
<cfset SubProductList31 = SubProductList31 & "s311;ALL;all" & "|">
<cfset SubProductList31 = SubProductList31 & "s312;ARPT;arpt" & "|">
<cfset SubProductList31 = SubProductList31 & "s313;RVSM;rvsm" & "|">
<cfset SubProductList31 = SubProductList31 & "s314;DAFIF;dafif" & "|">
...
<cfif PageNum EQ 2>
	...
	<cfelse>
	    ...
	    <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td background="/images/content_frame_images/content_frame_left.gif"><img src="/images/spacer.gif" width="6" height="1" alt=""></td>
            <td width="100%" bgcolor="#FFFFFF">
              <!-- start text search form -->
              <form name="searchForm" action="/default.htm" method="post">
			  <div align="right"><A href="javascript:void(0);" onClick="expandcontent(this, 'omit')"><img src="/images/show-hide.gif" width="84" height="24" border="0" alt="Show/Hide Search Panel"></A><br>&nbsp;</div>
<!--- 			<img src="/images/main_table_images/alert_icon.gif" onClick="expandcontent(this, 'omit')" style="cursor:hand; cursor:pointer" alt="Hide/Show Search Criteria"> --->
    ...
    <td width="36%" rowspan="2" valign="top" class="formTableBorder">
      <div class="menuWrap" style="height: 250px">
        ...
        <div class="SearchMenuBG2" style="padding-top: 3px"><span class="sideMenuFontLev2">
          <input type="radio" name="repType" id="repType" value="1" checked onClick="expandcontent(this, 'sc1');switchRegion('region1');" style="cursor:hand; cursor:pointer;">
        ...
        <div class="SearchMenuBG2"><span class="sideMenuFontLev2">
          <input type="radio" name="repType" id="repType" value="2"   onClick="expandcontent(this, 'sc2');switchRegion('region2');" style="cursor:hand; cursor:pointer;">
          SIGMETs</span></div>
        <div id="sc2" class="switchcontent">
          <table width="95%" border="0">
 --->
                  <tr>
                    <td width="17%" rowspan="2" align="center" class="formTable" valign="top"><a href="http://weathernews.com/us/c"><img src="/images/main_table_images/wni_logo.gif" alt="Weathernews Logo" width="114" height="43" border="0"></a></td>
                    <td width="36%" rowspan="2" valign="top" class="formTableBorder">
                      <div class="menuWrap" style="height: 250px">
                        <div class="SearchMenuBG1"><span class="sideMenuFontLev1">Record Type*</span></div>

						<!--- METAR/TAF/NOTAM --->
						<div class="SearchMenuBG2" style="padding-top: 3px"><span class="sideMenuFontLev2"><input type="radio" name="repType" id="repType" value="1" <cfif repType EQ "1">checked</cfif> onClick="expandcontent(this, 'sc1');switchRegion('region1');enableTime(1);" style="cursor:hand; cursor:pointer;">METARs/TAFs/NOTAMs</span></div>
						<div id="sc1" class="switchcontent"  style="display:block">
							<cfloop list="#ProductList1#" index="LoopIndex" delimiters="|">
								...
								<cfset attrName = "FakeCheckBox_" & #currID#>
									...
									<div class="SearchMenuBG3"><span class="sideMenuFontLev2">
										<img <cfif IsDefined("#attrName#")>src="/images/checkBox_on.gif"<cfelse>src="/images/checkBox_off.gif"</cfif> name="#attrName#" id="#attrName#" onClick="changeImages2('#attrName#');enableTime(1);<cfif attrName EQ "FakeCheckBox_13">if (document.getElementById('FakeCheckBox_13').src.indexOf('checkBox_on.gif') != -1) {document.getElementById('metarstationlist').style.display = 'none';document.getElementById('metarstationtext').style.display = 'none';document.getElementById('notamsubmenu').style.display = 'block'; }<cfelse>document.getElementById('metarstationlist').style.display = 'block';document.getElementById('metarstationtext').style.display = 'block';document.getElementById('notamsubmenu').style.display = 'none';</cfif>">&nbsp;#currName#</span></div>
						...
						<!--- SIGMETs --->
						<div class="SearchMenuBG2"  style="padding-top: 3px"><span class="sideMenuFontLev2"><input type="radio" name="repType" id="repType" value="2" <cfif repType EQ "2">checked</cfif>  onClick="expandcontent(this, 'sc2');switchRegion('region2');enableTime(2);" style="cursor:hand; cursor:pointer;">SIGMETs</span></div>
						<div id="sc2" class="switchcontent">
								...
								<cfloop list="#ProductList2#" index="LoopIndex" delimiters="|">
									...
									<cfset attrName = "FakeCheckBox_" & #currID#>
										...
										<div class="SearchMenuBG3" style="border-right-style:none;"><span class="sideMenuFontLev2">
											<img <cfif IsDefined("#attrName#")>src="/images/checkBox_on.gif"<cfelse>src="/images/checkBox_off.gif"</cfif> name="#attrName#" id="#attrName#" onClick="changeImages2('#attrName#');enableTime(1);">&nbsp;#currName#</span></div>
										<div style="display:none"><input type="checkbox" name="#attrName#" id="#attrName#" value="#currID#" <cfif IsDefined("#attrName#")>checked</cfif>></div>
										</cfoutput>	
...
<!--- 								</td>
 ...
 --->			
						...
						<div class="SearchMenuBG2" style="padding-top: 3px"><span class="sideMenuFontLev2"><input type="radio" name="repType" id="repType" value="3" <cfif repType EQ "3">checked</cfif> onClick="expandcontent(this, 'sc3');switchRegion('region3');enableTime(3);" style="cursor:hand; cursor:pointer;">US Weather Watches/Convective Outlooks</span></div>
...
<!--- save for later
						<div class="SearchMenuBG2"><span class="sideMenuFontLev2"><input type="radio" name="repType" id="repType" value="4" <cfif repType EQ "4">checked</cfif> onClick="expandcontent(this, 'sc4')" style="cursor:hand; cursor:pointer;">US AIRMETs</span></div>
			<div id="sc4" class="switchcontent">
								<cfloop list="#ProductList4#" index="LoopIndex" delimiters="|">
									...
									<cfset attrName = "FakeCheckBox_" & #currID#>
										<cfoutput>
										<div class="SearchMenuBG3"><span class="sideMenuFontLev2">
											<img <cfif IsDefined("#attrName#")>src="/images/checkBox_on.gif"<cfelse>src="/images/checkBox_off.gif"</cfif> name="#attrName#" id="#attrName#" onClick="changeImages2('#attrName#');">&nbsp;#currName#</span></div>
										<div style="display:none"><input type="checkbox" name="#attrName#" id="#attrName#" value="#currID#" <cfif IsDefined("#attrName#")>checked</cfif>></div>
										</cfoutput>	
								</cfloop>
			</div>			
 ...
 --->
 						<!--- US AIRMETs --->
 						<div class="SearchMenuBG2"><span class="sideMenuFontLev2"><input type="radio" name="repType" id="repType" value="4" <cfif repType EQ "4">checked</cfif> onClick="expandcontent(this, 'sc4');switchRegion('region4');enableTime(4);" style="cursor:hand; cursor:pointer;">AIRMETs</span></div>
						<div id="sc4" class="switchcontent">
							<cfloop list="#ProductList4#" index="LoopIndex" delimiters="|">
								<cfset currID = ListGetAt(LoopIndex,1,";")>
								<cfset currName = ListGetAt(LoopIndex,2,";")>
						...
						<div class="SearchMenuBG2"><span class="sideMenuFontLev2"><input type="radio" name="repType" id="repType" id="repType" value="5" <cfif repType EQ "5">checked</cfif> onClick="expandcontent(this, 'sc5');switchRegion('region5');enableTime(5);" style="cursor:hand; cursor:pointer;">US Winds and Temps Aloft</span></div>
						...
						<!--- PIREPs --->
						<div class="SearchMenuBG2"><span class="sideMenuFontLev2"><input type="radio" name="repType" id="repType" id="repType" value="6" <cfif repType EQ "6">checked</cfif> onClick="expandcontent(this, 'sc6');switchRegion('region6');enableTime(6);" style="cursor:hand; cursor:pointer;">PIREPs</span></div>
						<div id="sc6" class="switchcontent">
		                        <div class="sideMenuspacer">&nbsp;</div>
						</div>			

						<!--- Volcanic Ash Advisories --->
						<div class="SearchMenuBG2"><span class="sideMenuFontLev2"><input type="radio" name="repType" id="repType" id="repType" value="7" <cfif repType EQ "7">checked</cfif> onClick="expandcontent(this, 'sc7');switchRegion('region7');enableTime(3927);" style="cursor:hand; cursor:pointer;">Volcanic Ash Advisories</span></div>
						<div id="sc7" class="switchcontent">
		                        <div class="sideMenuspacer">&nbsp;</div>
						</div>			

						<!--- Airport Status Advisories --->
						<div class="SearchMenuBG2"><span class="sideMenuFontLev2"><input type="radio" name="repType" id="repType" value="8" <cfif repType EQ "8">checked</cfif> onClick="expandcontent(this, 'sc8');switchRegion('region8');enableTime(8);" style="cursor:hand; cursor:pointer;">Airport Status Information</span></div>
                      ...
                      <div class="menuWrap"  style="height: 50px">
						...
						<div id="timeCtrl">
                          <span class="selectLabel">From:</span>
							<select name="PeriodFrom" size="1"  style="font-size: 10px" onChange="enableTime(100);">
	                          ...
	                          <span class="selectLabel">To:</span>
								<select name="PeriodTo" size="1" style="font-size: 10px" onChange="enableTime(100);">
			  ...
			  <div id="region1" class="region" <cfif repType EQ "1">style="display:block" </cfif>>
                      ...
                      <div class="menuWrap"  style="height: 180px">
                        ...
                        <div class="sideMenuspacer">&nbsp;</div>
						<cfoutput>
							<div class="SearchMenuBG3" id="metarstationtext"><span class="sideMenuFontLev2">
								<input type="radio" name="Region" value="UserDef" onClick="document.searchForm.Stations.focus();enableTime(1);" <cfif Region EQ "UserDef">checked</cfif>>ICAO Stations
						...
						<div id="notamsubmenu" style="display:none;">
							<cfloop list="#SubProductList31#" index="LoopIndex" delimiters="|">
								<cfset currID = ListGetAt(LoopIndex,1,";")>
								<cfset currName = ListGetAt(LoopIndex,2,";")>
								<cfoutput>
									<div class="SearchMenuBG3"><span class="sideMenuFontLev2">
									<input type="radio" name="nType" value="#currName#" onClick="enableTime(1);document.getElementById('notamstationlist').style.display = 'block';" <cfif nType EQ currName>checked</cfif>>#currName#
									</span></div>
								</cfoutput>	
							</cfloop>
							<div id="notamstationlist" style="display:none;padding-right:30px;">
								ICAO Stations: <input type="text" name="Notam_Stations" size="15" maxlength="100" <cfif IsDefined("FORM.Notam_Stations")>value="<cfoutput>#FORM.Notam_Stations#</cfoutput>"</cfif>>
								<br>Comma separated (ex. KJFK,EGSS)
							</div>
						</div>
						<div id="metarstationlist">
						<cfloop list="#StationList#" index="LoopIndex" delimiters="|">
							<cfset currID = ListGetAt(LoopIndex,1,";")>
							<cfset currName = ListGetAt(LoopIndex,2,";")>
							<cfoutput>
								<div class="SearchMenuBG3"><span class="sideMenuFontLev2">
								<input type="radio" name="Region" value="#currID#" onClick="enableTime(1);" <cfif Region EQ #currID#>checked</cfif>>#currName#
								</span></div>
							</cfoutput>	
						</cfloop>
						</div>
						<!--- Check to see if Notams is checked, if it is, then make the submenu into notams --->
							<script>
								if (document.getElementById('FakeCheckBox_13').src.indexOf("checkBox_on.gif") != -1) {
									document.getElementById('metarstationlist').style.display = 'none';
									document.getElementById('metarstationtext').style.display = 'none';
									document.getElementById('notamsubmenu').style.display = 'block';
									document.getElementById('notamstationlist').style.display = 'block';
								}
							</script>
						...
						SAVE FOR LATER
								...
								<cfset LoopIndex = ListGetAt(SubProductList1,1,"|")>
									...
									<cfset attrName2 = "SubFakeTextBox_" & #currID#>
										<cfoutput>
										<div class="SearchMenuBG3"><span class="sideMenuFontLev2">
											<img <cfif IsDefined("#attrName2#")><cfif LEN(Evaluate(attrName2))>src="/images/checkBox_on.gif"<cfelse>src="/images/checkBox_off.gif"</cfif><cfelse>src="/images/checkBox_off.gif"</cfif> name="#attrName#" id="#attrName#" onClick="changeImages2('#attrName#');">&nbsp;#currName#:&nbsp;
...
<!--- 										<div style="display:none"><input type="checkbox" name="#attrName#" id="#attrName#" value="#currID#" <cfif IsDefined("#attrName#")>checked</cfif>></div> --->
								...
								<cfset LoopIndex = ListGetAt(SubProductList1,3,"|")>
									...
									<cfset attrName = "SubFakeCheckBox_" & #currID#>
										<cfoutput>
										<div class="SearchMenuBG3"><span class="sideMenuFontLev2">
											<img <cfif IsDefined("#attrName#")><cfif LEN(Evaluate(attrName))>src="/images/checkBox_on.gif"<cfelse>src="/images/checkBox_off.gif"</cfif><cfelse>src="/images/checkBox_off.gif"</cfif> name="#attrName#" id="#attrName#" onClick="changeImages2('#attrName#');">&nbsp;#currName#:&nbsp;
			...
			<div id="region3" class="region" <cfif repType EQ "3">style="display:block" </cfif>>
                      ...
                      <div class="menuWrap"  style="height: 200px">
                        ...
                        <div class="sideMenuBG2"><span class="sideMenuFontLev2">
                          ...
                          City</span></div>
                        <div class="sideMenuBG3"><span class="sideMenuFontLev2"><img src="/images/checkBox_off.gif" width="10" height="10">&nbsp;Atlanta</span></div>
                        <div class="sideMenuBG3"><span class="sideMenuFontLev2"><img src="/images/checkBox_on.gif" width="10" height="10">&nbsp;Newark</span></div>
                        <div class="sideMenuBG3"><span class="sideMenuFontLev2"><img src="/images/checkBox_off.gif" width="10" height="10">&nbsp;Chicago</span></div>
                        <div class="sideMenuBG3"><span class="sideMenuFontLev2"><img src="/images//checkBox_on.gif" width="10" height="10">&nbsp;Salt
                            Lake City</span></div>
                        <div class="sideMenuspacer">&nbsp;</div>
                        <div class="sideMenuBG2"><span class="sideMenuFontLev2">
                        ...
                        <div class="sideMenuBG2"><span class="sideMenuFontLev2">
                          <input type="radio" name="RegionsRadioGroup" value="radiobutton">
                          Region</span></div>
                        <div class="sideMenuBG3"><span class="sideMenuFontLev2"><img src="/images/checkBox_off.gif" width="10" height="10">&nbsp;Region
                            1</span></div>
                        <div class="sideMenuBG3"><span class="sideMenuFontLev2"><img src="/images/checkBox_off.gif" width="10" height="10">&nbsp;Region
                            2</span></div>
                        <div class="sideMenuBG3"><span class="sideMenuFontLev2"><img src="/images/checkBox_off.gif" width="10" height="10">&nbsp;Region
			  ...
			  <div id="region6" class="region" <cfif repType EQ "6">style="display:block" </cfif>>
                      <div class="menuWrap"  style="height: 180px">
						...
						<cfloop list="#SubProductList6#" index="LoopIndex" delimiters="|">
							...
							<cfoutput>
								<div class="SearchMenuBG3"><span class="sideMenuFontLev2">
								<input type="radio" name="pType" value="#currID#" onClick="enableTime(1);" <cfif pType EQ #currID#>checked</cfif>>#currName#
								</span></div>
							</cfoutput>	
						</cfloop>
						<cfoutput>
							<div class="SearchMenuBG3"><span class="sideMenuFontLev2">
								<input type="radio" name="pType" value="UserDef" onClick="document.searchForm.pTypeOther.focus();enableTime(1);" <cfif pType EQ "UserDef">checked</cfif>>Other
						...
						<cfloop list="#SubProductList6B#" index="LoopIndex" delimiters="|">
							...
							<cfoutput>
								<div class="SearchMenuBG3"><span class="sideMenuFontLev2">
								<input type="radio" name="intensity" value="#currID#" onClick="enableTime(1);" <cfif intensity EQ #currID#>checked</cfif>>#currName#
								</span></div>
							</cfoutput>	
						</cfloop>
						 <div class="sideMenuspacer">&nbsp;</div>
...
<!----
							...
							<cfoutput>
							<div class="SearchMenuBG3"><span class="sideMenuFontLev2">
								<img <cfif IsDefined("#attrName#")>src="/images/checkBox_on.gif"<cfelse>src="/images/checkBox_off.gif"</cfif> name="#attrName#" id="#attrName#" onClick="changeImages2('#attrName#');">&nbsp;
...
<!--- 					  
 ...
 --->			  
                    ...
                    <td width="15%" height="200" align="center" valign="top" class="formTableBorder">
                      ...
                      <input id="textSubmit" type="submit" name="Submit" value="Search" class="submit-button" disabled>
