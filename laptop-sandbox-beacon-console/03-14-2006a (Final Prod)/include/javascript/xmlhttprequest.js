	        ...
	        if (req.status == 200) {
	            ...
	            eval(functionA);
	             ...
	             alert("Error 7000: There was a problem retrieving the data from the server:\n" +
	                ...
	                this.url);
				errWin = window.open('','errWindow','width=400,height=400,scrollbars=yes,resize=yes');
				var windowHandler = errWin.document.body;
				/* windowHandler.innerHTML = "Error 7000: There was a problem retrieving the data from the server:\n" +
