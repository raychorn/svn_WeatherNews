...
<cfelse>
	...
	<!--- <cffile action="read" file="D:\Data\console\include\satellite_time.txt" variable="SatelliteTimesTmp"> 
...
<cfparam name="SatelliteTimes2" default="undefined" />
	...
	<cfloop list="#SatList#" index="SatLoopIndex" delimiters=";">
		...
		<cfif DisplayMapType EQ SatListType>
			...
			<cffile action="read" file="D:\Data\console\include\#SatFileName#" variable="SatelliteTimesTmp"> 
