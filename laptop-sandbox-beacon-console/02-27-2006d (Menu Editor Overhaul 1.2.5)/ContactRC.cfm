<!--- Contact RC --->
	<cfquery NAME="getRConDuty" DATASOURCE="#AVNOPS_DS#">
                  ...
                  <tr>
					...
					<cfoutput query="getRConDuty">
						<cfif ( (getRConDuty.CurrentRow MOD CEILING(getRConDuty.RecordCount/2) ) EQ 1 ) AND (getRConDuty.CurrentRow NEQ 1)>
							</td><td width="12"><img src="/images/spacer.gif" width="12" height="1"></td>
		                    <td valign="top">
						</cfif>
                      ...
                      <table width="100%" border="0" cellpadding="2" cellspacing="0">
                        <tr>
                          ...
                          <td width="100%" nowrap><img src="/images/spacer.gif" width="144" height="1"></td>
                        </tr>
                        <tr valign="top">
                          <td>
						  	<img src="/images/rconduty/#ImageName#.jpg" width="72" height="84" <cfif #OnDuty# EQ 0> style="filter:alpha(opacity=40);-moz-opacity:0.4" </cfif>>
						  </td>
                          <td nowrap>
                            <div style="position: relative; clear: both" id="RCinfo1">
                              ...
                              <div style="border: none; padding: 3px 6px 3px 2px"><span class="sideMenuFontLev2">#Title#<br>
								...
								<cfif #OnDuty# EQ 1>
 	                                <div style="float: left; width: 18px; position: absolute"><img src="/images/rconduty/available.gif" width="18" height="18"></div>
    	                            <div style="position: absolute; padding: 3px 0 0 18px; text-align: left"><span class="sideMenuFontLev2">On Duty</span></div><br><br>


								<cfelse>
	                                <div style="float: left; width: 18px; position: absolute"><img src="/images/rconduty/away.gif" width="18" height="18"></div>
