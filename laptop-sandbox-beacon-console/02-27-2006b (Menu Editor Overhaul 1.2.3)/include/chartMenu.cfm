...
<cfset list_winds_aloft_isotachs = list_winds_aloft_isotachs & "Atlantic<br>;ATLANTIC;950;650;3"& "|">
<cfset list_winds_aloft_isotachs = list_winds_aloft_isotachs & "Europe<br>;EURO;950;650;3"& "|">
<cfset list_winds_aloft_isotachs = list_winds_aloft_isotachs & "South America<br>;SA;950;650;3"& "|">
<cfset list_winds_aloft_isotachs = list_winds_aloft_isotachs & "Asia<br>;ASIA;950;650;3"& "|">
<!--- <cfset list_winds_aloft_isotachs = list_winds_aloft_isotachs & "South America<br>;SA;950;650;3"& "|"> --->

<cfset list_winds_temp = "">
<cfset list_winds_temp = list_winds_temp & "US<br>;NA;950;650;10"& "|">
<cfset list_winds_temp = list_winds_temp & "Atlantic<br>;ATLANTIC;950;650;10"& "|">
<cfset list_winds_temp = list_winds_temp & "Europe<br>;EURO;950;650;10"& "|">
<cfset list_winds_temp = list_winds_temp & "South America<br>;SA;950;650;10"& "|">
<cfset list_winds_temp = list_winds_temp & "Asia<br>;ASIA;950;650;10"& "|">
  		...
  		<cfloop index="LoopIndex" list="#WNILinksList#" delimiters="|">
			...
			<cfoutput>
				...
				<cfloop index="LoopIndex2" list="#Evaluate(currLoc)#" delimiters="|">
					...
					<a href="javascript:void(0);" onclick="newWin=openWin('#ListFirst(CGI.HTTP_REFERER,":")#://#CGI.HTTP_HOST#/include/imgNav2.cfm?uLoc=#URLEncodedFormat(currLoc)#&uW=#currWidth#&uH=#currHeight#&uTitle=#URlEncodedFormat(uTitle)#&uMap=#currMap#','WeathernewsBEACON','resizable=yes,status=no,scrollbars=yes,menubar=no,marginwidth=0,marginheight=0,width=#wAdj#,height=#hAdj#'); newWin.focus();">#currName#</a>
				</cfloop>
				</SPAN></DIV>
			</cfoutput>				
			<cfelse>
