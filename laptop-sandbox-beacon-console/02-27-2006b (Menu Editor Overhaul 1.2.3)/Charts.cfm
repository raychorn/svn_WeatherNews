...
<cfif isDefined("bboxAndLayers.layerString")>
	<cfset BBox = bBoxAndLayers.layerString>
                      ...
                      <td>
						...
						<cfelse>
				 		  <cfoutput>
							...
							<cf_img name="show" href="/default.htm?mID=5" src="#ListFirst(SlideShowList,',')#" NOSRC="/images/energy/noImage.jpg" TITLE="Click on the image to Redefine Your Selection" ALT="Click on the image to Redefine Your Selection">
						 </cfoutput>		
            ...
            <table width=130 border=0 cellpadding=0 cellspacing=0 bgcolor="#FFFFFF">
              ...
              <tr>
				...
				<cfif Animate EQ 0>
                      ...
                      <td><a href="/default.htm?mID=5&Animate=1" onmouseover="this.T_WIDTH=72;this.T_SHADOWWIDTH=3;this.T_TEMP=2500;return escape('Play animation')"><img src="/images/animation_control_images/buttons_3_off.gif" name="button3" width="15" height="17" border="0" id="button3"></a></td>
